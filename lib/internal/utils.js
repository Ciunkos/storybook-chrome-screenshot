...
exports.arrayChunk = exports.createArray = exports.pascalize = exports.story2filename = exports.viewport2string = exports.filenamify = exports.parseRegExp = exports.parseList = exports.parseInteger = exports.identity = exports.sleep = undefined;
...
var story2filename = exports.story2filename = function story2filename(kind, story) {
  ...
  return filenamify(kind + '-' + story + (viewport ? '-' + viewport2string(viewport) : '')) + '.png';
};
